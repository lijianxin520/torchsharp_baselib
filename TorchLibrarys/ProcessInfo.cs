...
namespace TorchLibrarys
{
    ...
    public class ProcessInfo
    {
        ...
        public ProcessInfo() : this(Console.CursorLeft, Console.CursorTop)
        {

        }

        public ProcessInfo(int left, int top, int width = 50, ProgressBarType ProgressBarType = ProgressBarType.Multicolor)
        {
            this.Left = left;
            this.Top = top;
            this.Width = width;
